...
<html lang="es">
    <head>
        ...
        <title>Modificación_DirecciónServiciosEscolares_IdentiQR</title>
    </head>
    <body>
        ...
        <div id = "generarJustificante">
            ...
            <form action="/IdentiQR/redireccionAcciones.php?controller=dirServEsco&action=updateServEsco" method="POST">
                <fieldset>
                    ...
                    <input type="submit" value="Actualizar servicio/tramite (Servicios escolares)" name = "actualizarTramite_Tramite" onclick="alert('Datos actualizados con éxito')">
                </fieldset>
            </form>
        <br>
