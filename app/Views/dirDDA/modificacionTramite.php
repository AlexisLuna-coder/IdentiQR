        ...
        <div id = "generarJustificante">
            ...
            <form action="/IdentiQR/redireccionAcciones.php?controller=dirDDA&action=updateDDA" method="POST">
                <fieldset>
                    ...
                    <input type="hidden" name="idDepto" id = "idDepto" value = "4"> <!--CONSIDERAR QUE CAMBIARÁ EL VALUE-->

                    <input type="submit" value="Actualizar servicio (TUTORÍAS)" name = "actualizarTramite_Tramite" onclick="alert('Datos actualizados con éxito')">
                </fieldset>
            </form>
        <br>
